...
// [output] integer
  ...
  // assign a highRangTime variable at 1487799420 
    // lowRangeTime variable at 1487794420
  ...
  function findBusiestPeriod(data) {
    ...
    function findBusiestPeriod(data) {
        ...
        let currentTime = 14877999420;
        let currentTrafficPop = 0; 
        let topTrafficPop = 0; 
        
        
        const busiestTime = data.reduce((topTrafficTime, currentIndex) => {
          console.log("hi")
          if (currentIndex[0] >= currentTime && currentIndex[2] === 1) {
             currentTrafficPop += currentIndex[1];
          } else if (currentIndex[0] >= currentTime && currentIndex[2] === 0) {
            currentTrafficPop -= currentIndex[1];
          };
